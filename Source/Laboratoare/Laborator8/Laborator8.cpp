...
void Laborator8::Init()
{
	...
	// Create a shader program for drawing face polygon with the color of the normal
	{
		...
		shader->AddShader(PATH_JOIN(window->props.selfDirPath, "Source", "Laboratoare", "Laborator8", "Shaders", "VertexShader.glsl"), GL_VERTEX_SHADER);
		shader->AddShader(PATH_JOIN(window->props.selfDirPath, "Source", "Laboratoare", "Laborator8", "Shaders", "FragmentShader.glsl"), GL_FRAGMENT_SHADER);
