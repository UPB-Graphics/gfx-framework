...
void Laborator7::Init()
{
	...
	// Create a shader program for drawing face polygon with the color of the normal
	{
		...
		shader->AddShader(PATH_JOIN(window->props.selfDirPath, SOURCE_PATH::ROOT, "Laboratoare", "Laborator7", "Shaders", "VertexShader.glsl"), GL_VERTEX_SHADER);
		shader->AddShader(PATH_JOIN(window->props.selfDirPath, SOURCE_PATH::ROOT, "Laboratoare", "Laborator7", "Shaders", "FragmentShader.glsl"), GL_FRAGMENT_SHADER);
