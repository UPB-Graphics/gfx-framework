...
void DeferredShading::FrameStart()
{

}

void DeferredShading::Update(float deltaTimeSeconds)
{
	ClearScreen();
...
void DeferredShading::FrameEnd()
{
	DrawCoordinatSystem();
}

void DeferredShading::LoadShader(std::string name)
{
	static std::string shaderPath = "Source/Laboratoare/DeferredShading/Shaders/";
...
void DeferredShading::OnInputUpdate(float deltaTime, int mods)
{
	// treat continuous update based on input
};

void DeferredShading::OnKeyPress(int key, int mods)
{
	// add key press event
...
void DeferredShading::OnKeyRelease(int key, int mods)
{
	// add key release event
};

void DeferredShading::OnMouseMove(int mouseX, int mouseY, int deltaX, int deltaY)
{
	// add mouse move event
};

void DeferredShading::OnMouseBtnPress(int mouseX, int mouseY, int button, int mods)
{
	// add mouse button press event
};

void DeferredShading::OnMouseBtnRelease(int mouseX, int mouseY, int button, int mods)
{
	// add mouse button release event
}

void DeferredShading::OnMouseScroll(int mouseX, int mouseY, int offsetX, int offsetY)
{
	// treat mouse scroll event
}

void DeferredShading::OnWindowResize(int width, int height)
{
