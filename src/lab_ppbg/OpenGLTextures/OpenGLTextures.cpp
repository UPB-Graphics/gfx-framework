...
void OpenGLTextures::FrameStart()
{
...
void OpenGLTextures::Update(float deltaTimeSeconds)
{
	{
...
void OpenGLTextures::FrameEnd()
{
	DrawCoordinatSystem();
}

void OpenGLTextures::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, Texture2D* texture1, Texture2D* texture2)
{
...
Texture2D* OpenGLTextures::CreateRandomTexture(unsigned int width, unsigned int height)
{
	GLuint textureID = 0;
...
void OpenGLTextures::OnInputUpdate(float deltaTime, int mods)
{
	float speed = 2;
...
void OpenGLTextures::OnKeyPress(int key, int mods)
{
	// add key press event
}

void OpenGLTextures::OnKeyRelease(int key, int mods)
{
	// add key release event
}

void OpenGLTextures::OnMouseMove(int mouseX, int mouseY, int deltaX, int deltaY)
{
	// add mouse move event
}

void OpenGLTextures::OnMouseBtnPress(int mouseX, int mouseY, int button, int mods)
{
	// add mouse button press event
}

void OpenGLTextures::OnMouseBtnRelease(int mouseX, int mouseY, int button, int mods)
{
	// add mouse button release event
}

void OpenGLTextures::OnMouseScroll(int mouseX, int mouseY, int offsetX, int offsetY)
{
}

void OpenGLTextures::OnWindowResize(int width, int height)
{
}
