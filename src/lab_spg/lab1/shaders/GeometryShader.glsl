...
void main()
{
    ...
    {
        // TODO(student): Modify offset so that instances are displayed on 6 columns
        vec3 offset = vec3(0,0,0);

        // TODO(student): Modify the points so that the triangle shrinks relative to its center
